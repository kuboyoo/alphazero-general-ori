...
def review(canonical_board, game, curPlayer, mcts, net, temp=0, mode=0):
  
  if mode == 0: #通常検討モード
    valids = game.getValidMoves(canonical_board, curPlayer)
  elif mode == 1: #盤面手動制御モード
    valids = canonical_board.valid_moves(curPlayer)
    canonical_board = canonical_board.get_state()
  ...
  print("AI Value: ", value[curPlayer])
  #print("AI Suggest:")
...
def main(args):
  ...
  review(canonical_board, game, curPlayer, mcts, net, temp=1)
